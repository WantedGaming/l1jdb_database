...
<div class="admin-content-wrapper">
    <div class="page-header">
        <div class="breadcrumb">
            ...
            <a href="/l1jdb_database/admin/pages/bin/">Binary Tables</a> &raquo; 
            <a href="/l1jdb_database/admin/pages/bin/spawn_common/spawn_list_view.php?table=<?php echo urlencode($table); ?>">
    ...
    <div class="admin-btn-group">
        <a href="/l1jdb_database/admin/pages/bin/spawn_common/spawn_list_view.php?table=<?php echo urlencode($table); ?>" class="admin-btn admin-btn-secondary">
            Back to List
        </a>
