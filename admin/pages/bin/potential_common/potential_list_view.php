...
$count_query = "SELECT COUNT(*) as total FROM bin_potential_common";
...
<div class="page-header">
    <nav class="breadcrumb">
        ...
        <span>Potential Common List</span>
    </nav>
    <h1>Potential Common List</h1>
</div>
        ...
        <tbody>
            <?php if ($result && $result->num_rows > 0): ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr onclick="window.location.href='potential_detail_view.php?id=<?php echo $row['id']; ?>'" style="cursor: pointer;">
            ...
            <?php else: ?>
                <tr>
                    <td colspan="4" class="text-center">No potential data found</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
